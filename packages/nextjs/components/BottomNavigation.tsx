...
export const BottomNavigation = () => {
  ...
  return (
    <div
      className={`fixed bottom-0 left-0 right-0 z-50 bg-base-100/80 backdrop-blur-lg border-t border-base-300 transition-transform duration-300 ${
        isInGameArea ? "translate-y-full" : "translate-y-0"
      }`}
    >
